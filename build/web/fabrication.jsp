...
<main role="main" class="main-content">
    <div class="card shadow mb-4">
        <div class="card-header">
            <strong class="card-title">COMPOSITION MEUBLE</strong>
        </div>
        <div class="card-body">
            <form method="post" action="Servletformule">
                <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Meuble</label>
                    <div class="col-sm-3">
                        <select name="id"  id="id" class="form-control">
                            <% for (int i = 0; i < description.length; i++) {%>
                            <option value="<%=description[i].getIdstyle().getIdStyle()+"-"+description[i].getIdmere()%>">
                ...
                <div class="form-group mb-2">
                    <button type="submit" class="btn btn-primary">Creation Formule</button>
                </div>
            </form>
        </div>
        <div class="card-header">
