...
create sequence seq_fabrication_mouvement;
create table fabrication_mouvement (
    id_fabrication_mouvement varchar default 'FM'||(nextval('seq_fabrication_mouvement')) primary key,
    id_mere varchar references mere(idmere),
    quantite_entree float default 0,
    quantite_sortie float default 0,
    date_fabrication_mouvement date default now()
);
-- 
create view detail_mouvement as select mouvement. *,materiel.nom from mouvement join materiel on materiel.idmateriel = mouvement.id_materiel;