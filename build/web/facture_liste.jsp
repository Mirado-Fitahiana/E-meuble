            ...
            <table class="table datatables" id="dataTable-1">
                ...
                <tbody>  
                    ...
                    <tr>
                        ...
                        <td><a href="ServletListeFacture?detail=<%=liste_f_tab[i].getId_vente() %>"><button class="btn mb-2 btn-outline-info">detail facture</button></a></td>
                        <td><a href="ServletListeFacture?vente=<%=liste_f_tab[i].getId_vente() %>"><button class="btn mb-2 btn-outline-warning">historique Payement</button></a></td>
